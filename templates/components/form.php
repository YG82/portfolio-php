<div class="m-4 shadow-sm">
  <form action="" method="post" class="flex flex-col gap-3" id="contactForm">
    <!-- Objets -->
    <div>
      <select name="object" id="object" class="border border-slate-200 rounded-lg px-4 py-2 bg-transparent text-slate-800 w-full focus:outline-none">
    ...
    <fieldset class="border border-slate-200 rounded-lg px-4 py-2">
      ...
      <div class="flex gap-4 my-4">
        <div class="flex flex-col gap-2">
          ...
          <input type="text" name="firstname" id="firstname" placeholder="Martin" value="Martine" minlength="2" maxlength="80" class="border border-slate-200 rounded-lg px-4 py-2 focus:outline-none" required>
        </div>
        <div class="flex flex-col gap-2">
          <label for="lastname" class="font-semibold text-lg">Votre nom</label>
          <input type="text" name="lastname" id="lastname" placeholder="Dupont" value="Dupont" minlength="2" maxlength="80" class="border border-slate-200 rounded-lg px-4 py-2 focus:outline-none" required>
        </div>
      </div>
    </fieldset>
    ...
    <fieldset class="border border-slate-200 rounded-lg px-4 py-2">
      ...
      <div class="flex gap-4 my-4">
        <div class="flex flex-col gap-2">
          ...
          <input type="email" name="email" id="email" placeholder="martin@gmail.com" value="martin@gmail.com" maxlength="80" class="border border-slate-200 rounded-lg px-4 py-2 focus:outline-none" required>
        </div>
        <div class="flex flex-col gap-2">
          <label for="telephone" class="font-semibold text-lg">Téléphone</label>
          <input type="tel" name="telephone" id="telephone" placeholder="0612345678" value="0612345678" minlength="10" maxlength="12" class="border border-slate-200 rounded-lg px-4 py-2 focus:outline-none" required>
        </div>
      </div>
    </fieldset>

    <!-- Message -->
    <textarea name="message" id="message" rows="10" class="border border-slate-200 rounded-lg px-4 py-2 focus:outline-none" placeholder="Votre message..." required minlength="100"></textarea>
